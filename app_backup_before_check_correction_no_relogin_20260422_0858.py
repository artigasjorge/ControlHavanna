...
def ensure_initial_admin() -> None:
    ...
    try:
        ...
        username = get_config_value("CONTROLHAVANNA_ADMIN_USER")
        password = get_config_value("CONTROLHAVANNA_ADMIN_PASSWORD")
        full_name = get_config_value("CONTROLHAVANNA_ADMIN_NAME", "Administrador del sistema")
...
def login() -> None:
    ...
    if not has_any_user():
        st.error(
            "No hay usuarios creados. Configure CONTROLHAVANNA_ADMIN_USER y "
            "CONTROLHAVANNA_ADMIN_PASSWORD en los secretos de Streamlit Cloud "
            "o en las variables de entorno, y reinicie la aplicacion."
        )
        return
